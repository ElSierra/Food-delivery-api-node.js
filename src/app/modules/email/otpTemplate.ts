          ...
          <div class="body">
              ...
              <div style="display: flex;">
                  <div>
                      ...
                      <p style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 200;">Please use the following
                          verification code to verify your account:</p>
                      <p style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 300;">${email}</p>
                      <div class="code" style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800;">${otp}
                      </div>
